...
public:
    ...
    void deleteFrame()
    {
        ...
        // Store which frame we're deleting
        int frameToDelete = currentFrame;

        // Delete only the current frame
...
int main()
{
    ...
    while (running)
    {
        ...
        for (size_t i = 0; i < canvas.frames.size(); ++i)
        {
            ...
            drawButton(window, sf::FloatRect(r.left + 80, buttonY, 20, 20), font, "dn");
