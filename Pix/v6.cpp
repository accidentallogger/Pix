    ...
    while (running)
    {
        ...
        while (window.pollEvent(ev))
        {
            ...
            else if (ev.type == sf::Event::KeyPressed)
            {
                ...
                else if (ev.key.code == sf::Keyboard::Enter && renamingFrame)
                {
                    // Finish renaming
                ...
                else if (ev.key.code == sf::Keyboard::Escape && renamingFrame)
                {
                    // Cancel renaming
                    renamingFrame = false;
                    frameToRename = -1;
