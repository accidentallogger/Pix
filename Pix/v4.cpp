...
public:
    ...
    void duplicateFrame()
    {
        ...
        newFrame.name = "Frame " + std::to_string(frames.size());
    ...
    while (running)
    {
        ...
        while (window.pollEvent(ev))
        {
            ...
            else if (ev.type == sf::Event::TextEntered && showResizeDialog)
            {
                ...
                {
                    if (editingWidth && !newWidthStr.empty())
                        newWidthStr.pop_back();
                    else if (!!editingWidth && !newHeightStr.empty())
        ...
        if (leftMouseDown && mouseInCanvas && !uiElementClicked && !colorPicker.isOpen && !showResizeDialog)
        {
        ...
        if (leftMouseDown && sf::Mouse::getPosition(window).x >= (int)x && sf::Mouse::getPosition(window).x <= (int)(x + bw) &&
        ...
        if (leftMouseDown && sf::Mouse::getPosition(window).x >= (int)(colorX + 40) && sf::Mouse::getPosition(window).x <= (int)(colorX + 40 + 60) &&
            sf::Mouse::getPosition(window).y >= (int)y && sf::Mouse::getPosition(window).y <= (int)(y + bh))
        {
        ...
        if (leftMouseDown && sf::Mouse::getPosition(window).x >= (int)(colorX + 110) && sf::Mouse::getPosition(window).x <= (int)(colorX + 110 + 80) &&
            sf::Mouse::getPosition(window).y >= (int)y && sf::Mouse::getPosition(window).y <= (int)(y + bh))
        {
            showResizeDialog = !showResizeDialog;
            newWidthStr = std::to_string(canvas.width);
        ...
        // Animation controls
        float controlY = sidebar.top + 8;
        drawButton(window, sf::FloatRect(sidebar.left + 8, controlY, 60, 28), font, playing ? "Stop" : "Play");
        if (leftMouseDown && !uiElementClicked)
        {
            sf::Vector2i mm = sf::Mouse::getPosition(window);
            if (mm.x >= (int)(sidebar.left + 8) && mm.x <= (int)(sidebar.left + 68) &&
                mm.y >= (int)controlY && mm.y <= (int)(controlY + 28))
            {
                playing = !playing;
                uiElementClicked = true;
            }
        ...
        drawButton(window, sf::FloatRect(sidebar.left + 76, controlY, 28, 28), font, "<");
        if (leftMouseDown && !uiElementClicked)
        {
            sf::Vector2i mm = sf::Mouse::getPosition(window);
            if (mm.x >= (int)(sidebar.left + 76) && mm.x <= (int)(sidebar.left + 104) &&
                mm.y >= (int)controlY && mm.y <= (int)(controlY + 28))
            {
                canvas.prevFrame();
                uiElementClicked = true;
        ...
        drawButton(window, sf::FloatRect(sidebar.left + 112, controlY, 28, 28), font, ">");
        if (leftMouseDown && !uiElementClicked)
        {
            sf::Vector2i mm = sf::Mouse::getPosition(window);
            if (mm.x >= (int)(sidebar.left + 112) && mm.x <= (int)(sidebar.left + 140) &&
                mm.y >= (int)controlY && mm.y <= (int)(controlY + 28))
            {
                canvas.nextFrame();
                uiElementClicked = true;
        ...
        for (size_t i = 0; i < canvas.frames.size(); ++i)
        {
            ...
            drawButton(window, sf::FloatRect(r.left + 56, buttonY, 20, 20), font, "up");
            drawButton(window, sf::FloatRect(r.left + 80, buttonY, 20, 20), font, "dp");
            drawButton(window, sf::FloatRect(r.left + 104, buttonY, 20, 20), font, "D");
            drawButton(window, sf::FloatRect(r.left + 128, buttonY, 20, 20), font, "X");
            ...
            if (leftMouseDown && !uiElementClicked)
            {
                ...
                if (mm.x >= (int)r.left && mm.x <= (int)(r.left + r.width) && mm.y >= (int)r.top && mm.y <= (int)(r.top + r.height))
                {
                    ...
                    else if (mm.x >= (int)(r.left + 104) && mm.x <= (int)(r.left + 124) && mm.y >= (int)buttonY && mm.y <= (int)(buttonY + 20))
                    {
                        // Duplicate
                        canvas.duplicateFrame();
                        uiElementClicked = true;
                    }
                    else if (mm.x >= (int)(r.left + 128) && mm.x <= (int)(r.left + 148) && mm.y >= (int)buttonY && mm.y <= (int)(buttonY + 20))
                    {
                        // Delete
                        canvas.deleteFrame();
                        uiElementClicked = true;
        ...
        {
            sf::Vector2i mm = sf::Mouse::getPosition(window);
            if (mm.x >= (int)(sidebar.left + 8) && mm.x <= (int)(sidebar.left + 88) && mm.y >= (int)(fy + 8) && mm.y <= (int)(fy + 36))
            {
                canvas.addFrame();
                uiElementClicked = true;
            }
        ...
        {
            sf::Vector2i mm = sf::Mouse::getPosition(window);
            if (mm.x >= (int)(sidebar.left + 96) && mm.x <= (int)(sidebar.left + 176) && mm.y >= (int)(fy + 8) && mm.y <= (int)(fy + 36))
            {
        ...
        if (showResizeDialog)
        {
            ...
            widthInput.setOutlineColor(editingWidth ? sf::Color::Yellow : sf::Color::White);
            ...
            heightInput.setOutlineColor(!editingWidth ? sf::Color::Yellow : sf::Color::White);
